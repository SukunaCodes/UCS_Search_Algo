...
def uniformCostSearch(graph, origin, goal):
    ...
    while frontier:
        ...
        # Delete from the dictionary the element that has been popped
...
strath_map = gc.load_graph("locations.json")
solution = uniformCostSearch(strath_map, "sports_complex", "parkinglot")
print("SOLUTION: {}".format(solution))
gc.show_weighted_graph(strath_map, 1000, 13, (10, 5))
